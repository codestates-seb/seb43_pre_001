...
const reviewTitle = 'Make sure we don’t already have an answer for your question';
const reviewDesc = [
...
export { askTitle, askDesc, problemTitle, problemDesc, tryTitle, tryDesc, tagsTitle, tagsDesc, reviewTitle, reviewDesc };
