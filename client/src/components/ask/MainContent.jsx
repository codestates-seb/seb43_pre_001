...
function MainContent() {
  return (
    <div>
      ...
      <Div>
        <p>
          You’re ready to ask a programming-related question and this form will help guide you through the process. Looking to ask a non-programming
      ...
      {/* <Input inputTitle='Title' inputDesc='Be specific and imagine you’re asking a question to another person.' />
      <Notice />
      <TextEditor
      ...
      />
      <Input inputTitle='Tags' inputDesc='Add up to 5 tags to describe what your question is about. Start typing to see suggestions.' /> */}
      {/* <Notice />
      <Input
